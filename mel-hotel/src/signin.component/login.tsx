...
export default function LoginFC() {
  ...
  const onLogin = async() =>{
    const gmailElement = document.getElementById("inputGmail") as HTMLInputElement;
  ...
  return (
    <div className="flex h-dvh flex-col items-center justify-center bg-gray-100">
      <div className="min-w-md flex h-max w-full max-w-md flex-col gap-4 rounded-md px-8 py-8 shadow drop-shadow">
        ...
        <button className="rounded bg-[#f09247] py-2 text-white shadow" onClick={onLogin}>
          Login
        </button>
        <div>
        ...
        <Link to={"/signin"}
          className="text-contrast rounded flex items-center flex-col bg-gray-50 py-2 shadow">
