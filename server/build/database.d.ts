...
export declare function insertDocument(collection: Collection, doc: Document): Promise<import("mongodb").InsertOneResult<import("bson").Document>>;
...
export declare function updateDocument(collection: Collection, id: string, doc: Document): Promise<import("mongodb").UpdateResult<import("bson").Document>>;
